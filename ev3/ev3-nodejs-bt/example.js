...
var example_program_sensor = function(target){
  ...
  // 
  //set set port 1 as a touch sensor 
  ...
  // e.g. set port 2 as a color sensor in mode color
  ...
  //set set port 2 as a color sensor (in light reflection intensity mode)
  /**
  ...
  //set set port 2 as a color sensor (in ambient light intensity mode)
  /**
   * target.registerSensor(2,target.S_TYPE_COLOR,target.SM_COL_AINTENSITY)
   * target.registerSensorListener(1,function(result){
   *   console.log("xxx: 3");
   *   //should ge a numeric result ranging from 1 to 100
   *   console.log(result);
